...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_constraint('fk_email_news_user_email_news_id', 'email_news_user', type_='foreignkey')
    op.drop_constraint('fk_email_news_user_users_id', 'email_news_user', type_='foreignkey')
