...
def downgrade():
    ...
    op.drop_constraint('watch_local_service_keychest_agent_id', 'watch_local_service', type_='foreignkey')
    op.drop_constraint('watch_local_service_watch_service_id', 'watch_local_service', type_='foreignkey')
    op.drop_constraint('watch_service_base_domain_id', 'watch_service', type_='foreignkey')
    op.drop_constraint('organization_group_organization_id', 'organization_group', type_='foreignkey')
    op.drop_constraint('organization_group_organization_group_id', 'organization_group', type_='foreignkey')
    op.drop_constraint('keychest_agent_organization_id', 'keychest_agent', type_='foreignkey')
