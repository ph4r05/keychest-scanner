...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_constraint('fk_user_ip_scan_record_users_id', 'user_ip_scan_record', type_='foreignkey')
    op.drop_constraint('fk_ip_scan_record_ip_scan_record_id', 'user_ip_scan_record', type_='foreignkey')
    op.drop_constraint('fk_ip_scan_result_ip_scan_record_id', 'ip_scan_result', type_='foreignkey')
    op.drop_constraint('fk_ip_scan_record_watch_service_id', 'ip_scan_record', type_='foreignkey')
    op.drop_constraint('fk_scan_web_app_scan_tls_desc_id', 'scan_web_app', type_='foreignkey')
    op.drop_constraint('fk_scan_tls_desc_ext_scan_tls_desc_id', 'scan_tls_desc_ext', type_='foreignkey')
    op.drop_constraint('fk_scan_tls_desc_ext_scan_tls_params_id', 'scan_tls_desc_ext', type_='foreignkey')
    op.drop_constraint('fk_scan_tls_desc_ip_address_id', 'scan_tls_desc', type_='foreignkey')
    op.drop_constraint('fk_scan_tls_desc_watch_service_id', 'scan_tls_desc', type_='foreignkey')
    op.drop_constraint('domain_name_base_domain_id', 'domain_name', type_='foreignkey')
