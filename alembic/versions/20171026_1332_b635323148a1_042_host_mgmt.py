...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], name='managed_hosts_users_id', ondelete='CASCADE'),
    ...
    sa.Column('updated_at', sa.DateTime(), nullable=True),
    sa.Column('deleted_at', sa.DateTime(), nullable=True),
    sa.ForeignKeyConstraint(['group_id'], ['managed_host_groups.id'], name='managed_host_to_groups_group_id', ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['host_id'], ['managed_hosts.id'], name='managed_host_to_groups_host_id', ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id'),
    ...
    sa.Column('updated_at', sa.DateTime(), nullable=True),
    sa.Column('deleted_at', sa.DateTime(), nullable=True),
    sa.ForeignKeyConstraint(['agent_id'], ['keychest_agent.id'], name='managed_hosts_agent_id', ondelete='NULL'),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], name='managed_hosts_users_id', ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id')
    )
