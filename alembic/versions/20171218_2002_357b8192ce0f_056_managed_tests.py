...
def upgrade():
    ...
    op.create_table('managed_test_profiles',
                    ...
                    sa.ForeignKeyConstraint(['service_id'], ['managed_services.id'],
                                            name='fk_managed_test_profiles_managed_service_id', ondelete='CASCADE'),
                    sa.ForeignKeyConstraint(['solution_id'], ['managed_solutions.id'],
                                            name='fk_managed_test_profiles_managed_solution_id', ondelete='CASCADE'),
                    ...
                    sa.ForeignKeyConstraint(['watch_target_id'], ['watch_target.id'],
                                            name='fk_managed_test_profiles_watch_target_id', ondelete='SET NULL'),
                    sa.PrimaryKeyConstraint('id')
                    )
    op.create_index(op.f('ix_managed_test_profiles_scan_service_id'), 'managed_test_profiles', ['scan_service_id'], unique=False)
    op.create_index(op.f('ix_managed_test_profiles_service_id'), 'managed_test_profiles', ['service_id'], unique=False)
    op.create_index(op.f('ix_managed_test_profiles_solution_id'), 'managed_test_profiles', ['solution_id'], unique=False)
    op.create_index(op.f('ix_managed_test_profiles_top_domain_id'), 'managed_test_profiles', ['top_domain_id'], unique=False)
    op.create_index(op.f('ix_managed_test_profiles_watch_target_id'), 'managed_test_profiles', ['watch_target_id'], unique=False)
