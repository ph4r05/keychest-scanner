...
def upgrade():
    ...
    op.create_table('managed_test',
                    ...
                    sa.ForeignKeyConstraint(['host_id'], ['managed_hosts.id'], name='fk_managed_test_managed_host_id',
                                            ondelete='CASCADE'),
                    sa.ForeignKeyConstraint(['scan_service_id'], ['watch_service.id'],
                                            name='fk_managed_test_scan_service_id', ondelete='SET NULL'),
                    sa.ForeignKeyConstraint(['service_id'], ['managed_services.id'],
                                            name='fk_managed_test_managed_service_id', ondelete='CASCADE'),
                    sa.ForeignKeyConstraint(['solution_id'], ['managed_solutions.id'],
                                            name='fk_managed_test_managed_solution_id', ondelete='CASCADE'),
                    sa.ForeignKeyConstraint(['top_domain_id'], ['base_domain.id'],
                                            name='fk_managed_test_base_domain_id', ondelete='SET NULL'),
                    sa.ForeignKeyConstraint(['watch_target_id'], ['watch_target.id'],
                                            name='fk_managed_test_watch_target_id', ondelete='SET NULL'),
                    sa.PrimaryKeyConstraint('id')
                    )
    op.create_index(op.f('ix_managed_test_host_id'), 'managed_test', ['host_id'], unique=False)
    op.create_index(op.f('ix_managed_test_scan_service_id'), 'managed_test', ['scan_service_id'], unique=False)
    op.create_index(op.f('ix_managed_test_service_id'), 'managed_test', ['service_id'], unique=False)
    op.create_index(op.f('ix_managed_test_solution_id'), 'managed_test', ['solution_id'], unique=False)
    op.create_index(op.f('ix_managed_test_top_domain_id'), 'managed_test', ['top_domain_id'], unique=False)
    op.create_index(op.f('ix_managed_test_watch_target_id'), 'managed_test', ['watch_target_id'], unique=False)
    ...
    op.create_table('managed_cert_issue',
                    ...
                    sa.ForeignKeyConstraint(['test_id'], ['managed_test.id'], name='fk_managed_cert_issue_test_id',
                                            ondelete='CASCADE'),
                    sa.PrimaryKeyConstraint('id')
                    )
    ...
    op.create_foreign_key('tls_watch_managed_test_id', 'scan_handshakes', 'managed_test', ['test_id'], ['id'],
                          ondelete='SET NULL')
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_constraint('tls_watch_managed_test_id', 'scan_handshakes', type_='foreignkey')
    ...
    # op.drop_index(op.f('ix_managed_test_watch_target_id'), table_name='managed_test')
    # op.drop_index(op.f('ix_managed_test_top_domain_id'), table_name='managed_test')
    # op.drop_index(op.f('ix_managed_test_solution_id'), table_name='managed_test')
    # op.drop_index(op.f('ix_managed_test_service_id'), table_name='managed_test')
    # op.drop_index(op.f('ix_managed_test_scan_service_id'), table_name='managed_test')
    # op.drop_index(op.f('ix_managed_test_host_id'), table_name='managed_test')
    op.drop_table('managed_test')
    # ### end Alembic commands ###
