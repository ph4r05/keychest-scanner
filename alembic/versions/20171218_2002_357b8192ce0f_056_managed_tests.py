...
def upgrade():
    ...
    op.create_table('managed_tests',
                    ...
                    sa.ForeignKeyConstraint(['scan_service_id'], ['watch_service.id'],
                                            name='fk_managed_tests_scan_service_id', ondelete='SET NULL'),
                    ...
                    sa.ForeignKeyConstraint(['top_domain_id'], ['base_domain.id'],
                                            name='fk_managed_tests_base_domain_id', ondelete='SET NULL'),
                    sa.ForeignKeyConstraint(['watch_target_id'], ['watch_target.id'],
                                            name='fk_managed_tests_watch_target_id', ondelete='SET NULL'),
                    sa.PrimaryKeyConstraint('id')
                    )
    op.create_index(op.f('ix_managed_tests_host_id'), 'managed_tests', ['host_id'], unique=False)
    op.create_index(op.f('ix_managed_tests_scan_service_id'), 'managed_tests', ['scan_service_id'], unique=False)
    ...
    op.create_index(op.f('ix_managed_tests_top_domain_id'), 'managed_tests', ['top_domain_id'], unique=False)
    op.create_index(op.f('ix_managed_tests_watch_target_id'), 'managed_tests', ['watch_target_id'], unique=False)
