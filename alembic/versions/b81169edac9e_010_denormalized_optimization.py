...
def upgrade():
    ...
    op.add_column('scan_dns', sa.Column('num_ipv4', sa.SmallInteger(), nullable=False))
    op.add_column('scan_dns', sa.Column('num_ipv6', sa.SmallInteger(), nullable=False))
    op.add_column('scan_dns', sa.Column('num_res', sa.SmallInteger(), nullable=False))
